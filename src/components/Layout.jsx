...
import { 
  ...
  ChefHat, BarChart3, Grid3X3, Menu, X, LogOut
} from "lucide-react";
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-sidebar text-sidebar-foreground">
        ...
        <div className="p-4 border-t border-sidebar-border">
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium w-full text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground transition-all"
          >
